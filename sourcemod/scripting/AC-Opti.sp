...
float g_fPreviousDistTick[MAXPLAYERS+1]
    , g_fPreviousAngle[MAXPLAYERS+1]
    , g_fPreviousTurningAngle[MAXPLAYERS+1];

int g_iCurrentStrafe[MAXPLAYERS+1]
...
Action SetupMove(int client, float angles[3], float vel[3]) {
